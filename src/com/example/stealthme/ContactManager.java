// Class that handles fetching contact names from contact database
...
public class ContactManager
{
	...
	public void rebuildContactsList(Context context)
	{	
			...
			do
			{
				...
				{	
					...
					do
					{
						...
						curNumber = StringManager.removeSpecialCharacters(curNumber);
	...
	public String getKeyByValue(HashMap<String, List<String>> map, String value, Context context)
	{
		...
		for (Map.Entry<String, List<String>> entry : map.entrySet())
		{
			for (count = 0; count < entry.getValue().size(); count++)
			{
				...
				thisNumber = "1" + StringManager.removeSpecialCharacters(thisNumber);
